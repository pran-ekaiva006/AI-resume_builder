        ...
        <section id="how-it-works" className="py-24 bg-surface text-text-on-dark border-y-2 border-ink">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link
                to="/dashboard"
                className="inline-flex justify-center items-center bg-teal text-ink px-8 py-4 rounded-md font-body font-semibold text-lg hover:brightness-110 transition-all duration-300 shadow-sm"
              >
        ...
        <section className="py-24 bg-brass text-ink relative overflow-hidden">
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <Link 
                to="/auth/sign-in" 
                className="inline-flex justify-center items-center bg-ink text-text-on-dark px-10 py-4 rounded-md font-body font-semibold text-lg hover:bg-ink/90 transition-all duration-300 shadow-[4px_4px_0_rgba(16,19,28,0.2)] hover:-translate-y-1 hover:shadow-[6px_6px_0_rgba(16,19,28,0.2)]"
              >
                Get Started Now
              </Link>
            </motion.div>
